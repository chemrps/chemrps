...
#export SUPER_USER=system_admin
#export SUPERUSERPASSWORD=admin

#export BCF_AUTH_PASSWORD=demo1
#export BCF_AUTHENTICATORPASSWORD=demo1
#export BCF_REGPASSWORD=demo1
#export BCF_REG_FACADEPASSWORD=demo1
#export CHEMRPSDBNAME=chemrpsdemodb1